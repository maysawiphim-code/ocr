...
- บรรทัดที่มี "จํานวนสินค้ารวมXรายการ" หรือ "จำนวนสินค้ารวมๆรายการ" ติดท้ายชื่อสินค้า ให้ตัดส่วนนั้นทิ้ง
  เช่น "1 Bao_อาราบีก้า ลาเต้ร้อน 45.00 จํานวนสินค้ารวมๆรายการ" → ชื่อ "Bao อาราบีก้า ลาเต้ร้อน" ราคา 45.00
...
- บรรทัด "-40.00" หรือ "โปรโมชั่น" คือส่วนลด ให้ใส่เป็น item ชื่อ "ส่วนลด" ราคาติดลบ
- ถ้า raw text มี "จำนวนสินค้ารวม N รายการ" → ต้องได้ items ครบ N รายการ (ไม่นับส่วนลด)
- pos_id: ดึงจาก BNO เช่น BNO:S26061326N03 → pos_id = "1326" (4 หลักหลังปีเดือน)
- ชื่อสินค้าที่ OCR อ่านผิดให้แก้โดยเปรียบเทียบกับสินค้าในร้านสะดวกซื้อไทย:
  ...
  "ดาวน์นี่ปรับผ้า" → "ดาวน์นี่ น้ำยาปรับผ้านุ่ม"
  "เกลดเจลลาเวน" → "เจลลาเวนเดอร์"
  "MBLรองฟัน" → "เม็ดฟองฟันซุปเปอร์สเตป" """
    else:
...
- OCR อาจรวมสินค้า 2 รายการและ "จำนวนสินค้ารวมXรายการ" ไว้บรรทัดเดียว เช่น:
  "1 สกินแม็บยาสีฟัน 1 Bigsmileแปรงคนจัดฟัน จานวนสินค้ารวม2รายการ"
  → แยกเป็น 2 items: "1 สกินแม็บยาสีฟัน" และ "1 Bigsmileแปรงคนจัดฟัน"
  → "จำนวนสินค้ารวมXรายการ" ไม่ใช่สินค้า ให้ตัดทิ้ง
- "- 50.00" หรือ "40.00 - V" คือราคาของสินค้าบรรทัดก่อนหน้า ไม่ใช่ส่วนลด
- "-40.00" หรือ "โปรโมชั่น -40.00" คือส่วนลด ให้ใส่เป็น item ชื่อ "ส่วนลด" ราคาติดลบ
- OCR อ่านชื่อ Bao ผิดเป็น "Beo", "B80", "Be0", "Bo", "Bao_" → แปลงเป็น "Bao" เสมอ
- ถ้า raw text มี "จำนวนสินค้ารวม N รายการ" → ต้องได้ items ครบ N รายการ (ไม่นับส่วนลด)
- pos_id: ดึงจาก BNO เช่น BNO:S26061326N03 → pos_id = "1326" (4 หลักหลังปีเดือน)
- ชื่อสินค้าที่ OCR อ่านผิดให้แก้โดยเปรียบเทียบกับสินค้าในร้านสะดวกซื้อไทย:
