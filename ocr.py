...
- สินค้าที่ไม่รู้จักให้วิเคราะห์จากชื่อและลักษณะ ห้ามใส่ "สินค้าเบ็ดเตล็ดอื่นๆ" โดยไม่พยายามวิเคราะห์ก่อน
- ถ้าชื่อสินค้ามีคำว่า "Bao", "Beo", "B80" หรือคล้ายกัน ให้จัดเป็น "Bao Cafe" เสมอ
- ตอบเป็น JSON array เรียงตามลำดับเดิมเท่านั้น ไม่ต้องอธิบาย
- ตัวอย่าง: ["เครื่องดื่ม","อาหารพร้อมทานและเบเกอรี่","ของใช้ส่วนตัว","ขนมและของขบเคี้ยว"]"""
