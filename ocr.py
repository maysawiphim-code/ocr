...
# ─────────────────────────────────────────────────────────────────────────────
# ██  Google Drive OCR — Web OAuth Flow  ██
# ─────────────────────────────────────────────────────────────────────────────
...
2. อาหารพร้อมทานและเบเกอรี่
   ตัวอย่าง: ข้าวกล่อง แซนด์วิช บะหมี่กึ่งสำเร็จรูป ขนมปัง ไส้กรอก เค้ก ยูโรเค้ก ยูโรติก อาหารแช่แข็ง มาม่า มาม่าแพ็ค
   นอกตัวอย่าง: อาหารทุกชนิดที่กินได้ทันทีหรืออุ่นแล้วกิน รวมถึงเบเกอรี่และขนมอบทุกชนิด

3. ขนมและของขบเคี้ยว
   ตัวอย่าง: ลูกอม หมากฝรั่ง ช็อกโกแลต เฮอร์ชีย์ มันฝรั่งทอด ถั่ว สแน็ค โอโชะ ข้าวอบกรอบ
   นอกตัวอย่าง: ของกินเล่นทุกชนิดที่ไม่ใช่อาหารหลัก เช่น เยลลี่ คุกกี้ ป๊อปคอร์น ธัญพืชอบ

4. เครื่องดื่ม
   ตัวอย่าง: น้ำดื่ม น้ำอัดลม สไปรท์ โคคา ชา กาแฟ นม ไมโล คาราบาว เครื่องดื่มชูกำลัง อราวน์
   นอกตัวอย่าง: เครื่องดื่มทุกชนิดที่ไม่ใช่ Bao Cafe เช่น น้ำผลไม้ โยเกิร์ตดื่ม นมถั่วเหลือง เกลือแร่

5. ของใช้ส่วนตัว
   ตัวอย่าง: สบู่ แชมพู ยาสีฟัน แปรงสีฟัน ครีมอาบน้ำ โลชั่น ผ้าอนามัย
   นอกตัวอย่าง: ผลิตภัณฑ์ดูแลร่างกายทุกชนิด เช่น ดีโอ โรลออน แป้ง คอนแทคเลนส์ ผ้าเช็ดหน้า

6. ของใช้ในบ้าน
   ตัวอย่าง: ผงซักฟอก น้ำยาปรับผ้านุ่ม น้ำยาล้างจาน กระดาษทิชชู กระดาษชำระ ถุงขยะ
   นอกตัวอย่าง: ผลิตภัณฑ์ทำความสะอาดบ้าน เครื่องครัว ถุงพลาสติก แก้วน้ำ ถ้วย ช้อนส้อม

7. เวชภัณฑ์และอุปกรณ์ดูแลสุขภาพ
   ตัวอย่าง: ยาสามัญประจำบ้าน พลาสเตอร์ยา ยาหม่อง หน้ากากอนามัย
   นอกตัวอย่าง: ยาทุกชนิด วิตามิน อาหารเสริม เครื่องวัดความดัน ถุงยางอนามัย ผ้าพันแผล

8. สินค้าเบ็ดเตล็ดอื่นๆ
   ตัวอย่าง: ถ่านไฟฉาย ไฟแช็ก ปากกา สมุด บุหรี่ ซิการ์ แอล เอ็ม อุปกรณ์เครื่องเขียน บริการเติมเงิน
   นอกตัวอย่าง: สินค้าที่ไม่เข้าหมวด 1-7 เช่น บัตรเติมเงิน สายชาร์จ หูฟัง ของเล่น การ์ด

วิธีจัดหมวดสินค้าที่ไม่รู้จัก:
- ดูจากชื่อแบรนด์และประเภทสินค้า
- ถ้าเป็นสิ่งของกิน/ดื่ม → หมวด 2, 3, หรือ 4
- ถ้าเป็นของใช้ร่างกาย → หมวด 5
- ถ้าเป็นของใช้บ้าน → หมวด 6
- ถ้าเป็นยา/สุขภาพ → หมวด 7
- ถ้าไม่แน่ใจจริงๆ → หมวด 8"""

BAO_CAFE_MENU = """เมนู Bao Cafe ที่มีขายใน CJ Express (ใช้จับคู่ชื่อที่ OCR อ่านผิด):
เครื่องดื่มร้อน: ลาเต้ | อเมริกาโน่ | เอสเปรสโซ่ | คาปูชิโน่ | โกโก้ | ชาเขียว | ชาไทย
เครื่องดื่มเย็น: ลาเต้เย็น | อเมริกาโน่เย็น | เอสเปรสโซ่เย็น | คาปูชิโน่เย็น | โกโก้เย็น | ชาเขียวเย็น | ชาไทยเย็น | นมสตรอว์เบอร์รี | นมเขียวนมสด | โกโก้ปิ้ง
OCR มักอ่านผิด: "Bao_", "Beo", "B80", "Be0", "Ba0", "Bo," → ล้วนหมายถึง "Bao"
ถ้าชื่อสินค้าขึ้นต้นด้วย pattern ข้างต้นและตามด้วยชื่อเครื่องดื่ม → จัดเป็น "Bao Cafe" เสมอ"""

CJ_PRODUCT_KNOWLEDGE = """ความรู้เกี่ยวกับสินค้าในร้าน CJ Express / MORE (ใช้จัดหมวดหมู่):

อาหารพร้อมทานและเบเกอรี่:
- มาม่า/บะหมี่กึ่งสำเร็จรูป (มาม่า, ไวไว, ยำยำ) รวมแพ็ค x10, มาม่าหมูสับ, มาม่าต้มยำ
- ยูโรเค้ก, เค้กทุกชนิด, ขนมปัง, แซนด์วิช
- ยูโรติก / ยูโร ติก (สติ๊กสตางค์, ขนมปังกรอบแบบแท่ง, เวเฟอร์)
- ไส้กรอก, หมูแผ่น, เนื้อแผ่น
- ข้าวกล่อง, สลัด, อาหารพร้อมรับประทาน

ขนมและของขบเคี้ยว:
- เฮอร์ชีย์ (ช็อกโกแลต), เฮอร์ฟช็อกโกแลตครีม
- โอโชะ, ข้าวอบกรอบ, วอลนัท, คอร์นเนตโต
- มันฝรั่งทอด, ป๊อปคอร์น, ถั่ว, เยลลี่, ลูกอม, หมากฝรั่ง

เครื่องดื่ม:
- น้ำดื่ม (น้ำเปล่าทุกแบรนด์)
- สไปรท์, โคคาโคล่า, เป๊ปซี่, แฟนต้า (น้ำอัดลม)
- คาราบาวแดง, เอ็ม-150, กระทิงแดง (ชูกำลัง)
- อราวน์, ทีช, โออิชิ (ชา/กาแฟพร้อมดื่ม)
- ไมโล, โอวัลติน, นมทุกชนิด
- น้ำผลไม้, เกลือแร่ (Gatorade, Sponsor, 100Plus)

ของใช้ส่วนตัว:
- สบู่, ครีมอาบน้ำ (Dove, Lux, Safeguard)
- แชมพู, ครีมนวด (Pantene, Head&Shoulders)
- ยาสีฟัน, แปรงสีฟัน (Colgate, Oral-B)
- ผ้าอนามัย (Whisper, Sofy, Laurier)
- โลชั่น, ครีมทาผิว, ดีโอดอแรนท์

ของใช้ในบ้าน:
- กระดาษทิชชู, กระดาษชำระ (Cellox, Scott, Viva)
- ผงซักฟอก, น้ำยาปรับผ้านุ่ม (Comfort, Downy)
- น้ำยาล้างจาน (Sunlight, Vim)
- ถุงขยะ, ถุงพลาสติก, ฟิล์มห่ออาหาร

เวชภัณฑ์และอุปกรณ์ดูแลสุขภาพ:
- ยาพาราเซตามอล, ยาแก้ปวด, ยาลดไข้
- พลาสเตอร์, ผ้าพันแผล, แอลกอฮอล์
- หน้ากากอนามัย, วิตามิน, อาหารเสริม

สินค้าเบ็ดเตล็ดอื่นๆ:
- บุหรี่ (แอล แอนด์ เอ็ม, มาร์ลโบโร, แคมเมล)
- ไฟแช็ก, ถ่านไฟฉาย, ปากกา, สมุด
- บัตรเติมเงิน, SIM Card"""
...
def categorize_items_batch(items: list) -> list:
    ...
    try:
        ...
        prompt = f"""คุณคือผู้เชี่ยวชาญสินค้าในร้านสะดวกซื้อ CJ Express ประเทศไทย
...
กฎการจัดหมวดหมู่:
- เปรียบเทียบชื่อสินค้ากับฐานข้อมูลสินค้า CJ Express ด้านบนก่อนตัดสินใจ
- ถ้าชื่อคล้ายกับสินค้าในฐานข้อมูล ให้จัดตามหมวดนั้น
- ห้ามใส่ "สินค้าเบ็ดเตล็ดอื่นๆ" โดยไม่พยายามวิเคราะห์ก่อน
- ถ้าชื่อมี "Bao", "Beo", "B80", "Be0" ให้จัดเป็น "Bao Cafe" เสมอ
- ตอบเป็น JSON array เรียงตามลำดับเดิมเท่านั้น ไม่ต้องอธิบาย
- ตัวอย่าง: ["Bao Cafe","เครื่องดื่ม","อาหารพร้อมทานและเบเกอรี่","ขนมและของขบเคี้ยว"]"""
...
- บรรทัด 2: ราคาต่อหน่วย  (เช่น "39.00")
- บรรทัด 3: ราคารวม V  (เช่น "39.00 V" หรือ "86.00 V")
...
- OCR อาจรวมสินค้า 2 รายการไว้บรรทัดเดียว เช่น "1 คูลคูลเฟรช 12.00 1 วอลสท็อป 20.00 จํานวนสินค้ารวม2รายการ"
  → แยกเป็น 2 items ราคาจับคู่ตามลำดับ
- ชื่อสินค้าอาจถูกตัดสั้น เช่น "1 เซนได กาจ่อปลวกไว้" "1 PFPเต้าหู้ 120g" "1 เลิฟโพชั่นเลิฟซ่า" → ใช้ชื่อนั้นได้เลย
- OCR อ่านชื่อ Bao ผิดเป็น "Beo", "B80", "Be0", "Bo", "Bao_" → แปลงเป็น "Bao" เสมอ
- ส่วนลด: บรรทัด "-40.00", "-20.00", "-16.00" ฯลฯ ให้ใส่เป็น item ชื่อ "ส่วนลด" ราคาติดลบ
  เช่น {{"ชื่อสินค้า":"ส่วนลด","หมวดหมู่":"ส่วนลด/โปรโมชั่น","จำนวน":1,"ราคาต่อหน่วย":-20.0,"ยอดรวมสินค้า":-20.0}}
- ถ้า raw text มี "จำนวนสินค้ารวม N รายการ" → ต้องได้ items ครบ N รายการ (ไม่นับส่วนลด)
- pos_id: ดึงจาก BNO เช่น BNO:S26060707N01 → pos_id = "0707", BNO:S26061326N03 → pos_id = "1326"
- ชื่อสินค้าที่ OCR อ่านผิดให้แก้โดยเปรียบเทียบกับสินค้าในร้านสะดวกซื้อไทย:
  "ยูโร ติก สสสตางค" → "ยูโรติก สติ๊กสตางค์"
  "มาม่า หมุน" → "มาม่า หมูสับ"
  "โอโนะ" → "โอโชะ"
  "เปาผงซักฟอก" → "เปา ผงซักฟอก"
  "หากเก่นนมเปรี้ยว" → "ยาคูลท์นมเปรี้ยว"
  "เลิฟโทนเลิฟชาโยคา" → "เลิฟโพชั่นชาโยคา"
  "TGMคอทเทจ เบค่อน" → "TGM คอทเทจ เบคอน"
  "เกาลูนส้นแก้วสาหร่าย" → "เกาลูน สาหร่ายทะเล" """
    else:
...
- OCR อ่านชื่อ Bao ผิดเป็น "Beo", "B80", "Be0", "Bo", "Bao_" → แปลงเป็น "Bao" เสมอ
- ถ้า raw text มี "จำนวนสินค้ารวม N รายการ" → ต้องได้ items ครบ N รายการ (ไม่นับส่วนลด)
- pos_id: ดึงจาก BNO เช่น BNO:S26060707N01 → pos_id = "0707"
- ชื่อสินค้าที่ OCR อ่านผิดให้แก้โดยเปรียบเทียบกับสินค้าในร้านสะดวกซื้อไทย:
  "ยูโร ติก สสสตางค" → "ยูโรติก สติ๊กสตางค์"
  "มาม่า หมุน" → "มาม่า หมูสับ"
  "โอโนะ" → "โอโชะ" """
...
{{
  ...
  "items": [
    {{
      "ชื่อสินค้า": "ชื่อสินค้า (แก้ไขให้ถูกต้องถ้า OCR อ่านผิด)",
...
- ถ้ามีส่วนลด เช่น "-40.00" ให้ใส่เป็น item ชื่อ "ส่วนลด" ราคาติดลบ เช่น {{"ชื่อสินค้า": "ส่วนลด", "จำนวน": 1, "ราคาต่อหน่วย": -40.0, "ยอดรวมสินค้า": -40.0}}
...
def main():
    ...
    with st.expander("⚙️ ตัวเลือก OCR Engine", expanded=False):
        ...
        if S.ocr_engine == "gdrive":
            ...
            if vision_ready:
                st.success("✅ ตั้งค่า Google Vision API key แล้ว — พร้อมใช้งาน")
            else:
                st.warning("⚠️ ยังไม่ได้ตั้งค่า GOOGLE_VISION_API_KEY — ระบบจะใช้ Tesseract แทน")
        else:
        ...
        if gemini_ready:
            st.success(
                ...
                "ฟรี 1,500 requests/วัน (Gemini 2.0 Flash) — **1 บิล = 1 Gemini call**"
            )
        else:
            st.info(
